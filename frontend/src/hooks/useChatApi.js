...
export const useChatApi = (
  ...
  const sendMessage = async (messageContent, conversationId = 'default') => {
    ...
    try {
      ...
      // Also add to conversation cache if callback provided
      if (addMessageToConversation && conversationId) {
        const botMessageForCache = {
          id: botMessageId,
          type: 'bot',
        ...
        addMessageToConversation(conversationId, botMessageForCache);
      }
