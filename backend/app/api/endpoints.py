...
async def chat(request: ChatRequest, current_user: UserInfo):
    ...
    try:
        ...
        if user_message_saved:
            ...
            logger.warning("Failed to save user message to Firebase")
        ...
        if bot_message_saved:
            ...
            logger.warning("Failed to save bot response to Firebase")
...
async def get_conversation_messages(conversation_id: str, current_user: UserInfo):
    ...
    try:
        ...
        # Firebase service method is NOT async, so don't await it
...
# Update your api/endpoints.py chat function
